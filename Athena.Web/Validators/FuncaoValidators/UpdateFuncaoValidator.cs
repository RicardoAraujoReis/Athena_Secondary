...
public class UpdateFuncaoValidator : AbstractValidator<UpdateFuncao>
{
    public UpdateFuncaoValidator()
    {
    ...
    {
        var result = await ValidateAsync(ValidationContext<UpdateFuncao>
            .CreateWithOptions((UpdateFuncao)requestModel, x => x.IncludeProperties(propertyName)));
