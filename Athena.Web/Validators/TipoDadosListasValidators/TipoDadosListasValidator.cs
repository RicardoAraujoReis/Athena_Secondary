...
public class TipoDadosListasValidator : AbstractValidator<CreateTipoDadosListas>
{
    public TipoDadosListasValidator()
    {
    ...
    {
        var result = await ValidateAsync(ValidationContext<CreateTipoDadosListas>
            .CreateWithOptions((CreateTipoDadosListas)requestModel, x => x.IncludeProperties(propertyName)));
