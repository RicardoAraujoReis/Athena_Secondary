...
public class DepartamentoValidator : AbstractValidator<CreateDepartamento>
{
    ...
    {
        var result = await ValidateAsync(ValidationContext<CreateDepartamento>
            .CreateWithOptions((CreateDepartamento)requestModel, x => x.IncludeProperties(propertyName)));
