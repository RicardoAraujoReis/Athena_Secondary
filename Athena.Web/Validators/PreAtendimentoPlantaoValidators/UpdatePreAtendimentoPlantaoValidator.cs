...
public class UpdatePreAtendimentoPlantaoValidator : AbstractValidator<UpdatePreAtendimentoPlantao>
{
    ...
    {
        var result = await ValidateAsync(ValidationContext<UpdatePreAtendimentoPlantao>
            .CreateWithOptions((UpdatePreAtendimentoPlantao)requestModel, x => x.IncludeProperties(propertyName)));
