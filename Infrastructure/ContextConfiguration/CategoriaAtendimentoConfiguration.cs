...
internal class CategoriaAtendimentoConfiguration : IEntityTypeConfiguration<CategoriaAtendimento>
{
    public void Configure(EntityTypeBuilder<CategoriaAtendimento> builder)
    {
        ...
        builder.Property(x => x.Cat_catpai).HasMaxLength(10).HasAnnotation("CustomAnnotation", "ID da Categoria referência no nível anterior");
        builder.Property(x => x.Cat_despai).HasMaxLength(10);
        ...
        builder.Property(x => x.Cat_ativo).IsRequired().HasMaxLength(1);
