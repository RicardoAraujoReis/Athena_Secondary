...
internal class ClienteConfiguration : IEntityTypeConfiguration<Cliente>
{
    public void Configure(EntityTypeBuilder<Cliente> builder)
    {
        ...
        builder.HasKey(x => x.Cli_identi);

        builder.Property(x => x.Cli_descri).IsRequired().HasMaxLength(100).HasComment("Descrição do Cliente");
        builder.Property(x => x.Cli_ativo).IsRequired().HasMaxLength(1).HasComment("Indica se o Cliente está ativo ou não (S - SIM / N - NÃO)");
